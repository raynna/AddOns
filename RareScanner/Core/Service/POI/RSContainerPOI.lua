...
local function IsContainerPOIFiltered(containerID, mapID, zoneQuestID, prof, onWorldMap, onMinimap)
...
function RSContainerPOI.GetMapNotDiscoveredContainerPOIs(mapID, onWorldMap, onMinimap)
	...
	for containerID, _ in pairs(notDiscoveredContainerIDs) do
		...
		if (not filtered and not IsContainerPOIFiltered(containerID, mapID, containerInfo.zoneQuestId, containerInfo.prof, onWorldMap, onMinimap)) then
...
function RSContainerPOI.GetMapAlreadyFoundContainerPOI(containerID, alreadyFoundInfo, mapID, onWorldMap, onMinimap)
	...
	if (not IsContainerPOIFiltered(containerID, mapID, zoneQuestID, prof, onWorldMap, onMinimap)) then
